...
class ShouleInDet extends Component{
    ...
    componentDidMount(){
        ...
        // console.log('账目类型：', this.props.tradeType);
        myAjax({
        ...
        if(data.statusCode == 0){
            if(data.list.length != 0){
                ...
                data.list.forEach((ele, index) => {
                    if(ele.tradeType == '应收款'){
                        objArr.push(ele);
                    }                  
                });
                // console.log('详细数据11111111111：', objArr);
                this.setState({
                    cashDetailsObj : {
                        //店铺名
                        shopName : shopName,
    ...
    render(){
        ...
        <div className='sindet'>
            <div className='cashdetails__title'>
                {cashDetailsObj && (cashDetailsObj.shopName + ' ' + cashDetailsObj.nowCurryName)}应收款详情 
                </div>
