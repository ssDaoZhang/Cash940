...
class BankDet extends Component{
    ...
    componentDidMount(){
        ...
        myAjax({
            url : '/shop/getShopCardTransferDetail',
            data : {
    ...
    handBackDetails = (data) => {
        console.log('银行卡详情0000000000000000:', data);
